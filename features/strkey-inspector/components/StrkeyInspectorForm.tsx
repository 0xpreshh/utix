...
const defaults:RawInput={"value": ""};
const secretFields:string[]=["value"];
export function StrkeyInspectorForm({onSubmit,onEdit,pending}:{onSubmit:(raw:RawInput)=>void;onEdit:()=>void;pending:boolean}){
