...
const defaults:RawInput={"start": "", "end": "", "chunk": "", "oldest": "", "latest": "", "scope": "Requested range"};
const secretFields:string[]=[];
export function LedgerRangePlannerForm({onSubmit,onEdit,pending}:{onSubmit:(raw:RawInput)=>void;onEdit:()=>void;pending:boolean}){
