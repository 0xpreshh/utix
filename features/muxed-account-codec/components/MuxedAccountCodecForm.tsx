...
const defaults:RawInput={"mode": "Decode", "muxed": "", "base": "", "id": ""};
const secretFields:string[]=["muxed", "base"];
export function MuxedAccountCodecForm({onSubmit,onEdit,pending}:{onSubmit:(raw:RawInput)=>void;onEdit:()=>void;pending:boolean}){
