...
export const spec={route:"/tools/muxed-account-codec",steps:[
 {action:"visit",target:"/tools/muxed-account-codec"},{action:"submit",target:"empty form"},{action:"expect",target:"actionable validation error"},
 {action:"fill",target:"form",value:"deterministic sample from this slice's fixture"},{action:"click",target:"Analyze"},
 {action:"expect",target:"Muxed Account Encoder and Decoder result and exact copyable values; zero network requests"},
